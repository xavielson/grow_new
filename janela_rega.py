...
def abrir_janela_rega_edicao(janela_pai, salvar_callback, botao_modificar_horarios=None, hora_liga=None, hora_desliga=None):
    def fechar_janela():
...
def abrir_janela_rega_lista(janela_pai, output, salvar_callback=None):
    ...
    def botao_editar():
        ...
        def salvar(liga, desliga):
            ...
            if salvar_callback:
                salvar_callback()
        abrir_janela_rega_edicao(janela, salvar, None, horario["liga"], horario["desliga"])
